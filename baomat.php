...
$textl = 'Chính sách bảo mật';
$headmod = 'Chính sách bảo mật';
...
<h5>THU THẬP THÔNG TIN CÁ NHÂN CỦA BẠN</h5>
...
<h5>COOKIE / CÔNG NGHỆ THEO DÕI</h5>
...
Chính sách này được áp dụng xuyên suốt thời gian trang web này hoạt động.
      ...
      <p class="float-right">
	<img src="/sr/img/logonew.png" height="50" style="padding:5px;"/> 
    </p>
</div>
