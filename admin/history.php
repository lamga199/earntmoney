...
<div style="background:#999;color:#000;width:120px;padding:5px;margin:auto">Lịch sử hoạt động</div>
</div>	<div style="background:#E6E0F8;text-align:left;;padding:10px;">


	
<div style="text-align:center"><h4>Action (<? echo $total;?>)</h4></div>
...
<td class="bang">Status</td>
  ...
  <?php
	 ...
	 while($res=mysql_fetch_assoc($req)) {
		...
		<td class="bang">Video withdrawal</td>
